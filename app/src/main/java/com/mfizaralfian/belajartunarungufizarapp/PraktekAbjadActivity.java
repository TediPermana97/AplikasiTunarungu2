...
public class PraktekAbjadActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SimpleMediaSource mediaSource = new SimpleMediaSource("https://firebasestorage.googleapis.com/v0/b/sekripsi-fijar.appspot.com/o/Data%20File%2FVideo%20Depan%2FPRAKTEK.mp4?alt=media&token=ca23e5a6-0b4e-4d18-95f2-a0e8e299f6a3");
